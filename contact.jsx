...
export default function Contact(){ const [msg, setMsg] = useState(''); const [form, setForm] = useState({name:'', email:'', message:''}); function submit(e){ e.preventDefault(); setMsg('Thank you! We received your message.'); setForm({name:'',email:'',message:''}); }
  return (
